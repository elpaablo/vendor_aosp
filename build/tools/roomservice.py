...
custom_local_manifest = ".repo/local_manifests/extra.xml"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'aosp-13')
custom_dependencies = "aosp.dependencies"
org_manifest = "alpha-devices"  # leave empty if org is provided in manifest
org_display = "Alpha-Devices"  # needed for displaying
